...
class ISPConfigWS
{
    ...
    private function ws()
    {
        if (NULL != $this->client && $this->client instanceof \SoapClient)
            return $this->client;
    ...
    public function init($config = array())
    {
        ...
        $this->sessionId = $soapClient->login($this->config['user'], $this->config['pass']);
    ...
    {
        $client_id      = $this->extractParameter('_id');
